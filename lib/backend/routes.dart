...
import 'package:kopilism/frontend/widgets/generate_barcode.dart';
...
Map<String, WidgetBuilder> getAppRoutes() {
  return {
    ...
    //branch routes
    '/BranchNotifications': (context) => BranchNotifications(),
    '/BranchHistory': (context) => OrderHistoryScreen(),
    '/BranchHome': (context) => BranchHome(),
    '/BranchCategory': (context) => BranchCategory(),
    '/BranchOrders': (context) => BranchOrders(),
    '/Generate': (context) => const BarcodeGeneratorComponent(),
  };
}
